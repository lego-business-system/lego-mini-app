...
(function(){
  ...
  async function install(){
    ...
    return window.BusinessArchitectureContentV136 && window.BusinessArchitectureContentV136["PART-03"];
  }
  window.BusinessArchitectureContentLoaderV136=window.BusinessArchitectureContentLoaderV136||{};
  window.BusinessArchitectureContentLoaderV136["PART-03"]=install();
})();
