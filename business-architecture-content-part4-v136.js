/* АРХИТЕКТУРА — загрузчик содержимого PART-04 v136 */
(function(){
  "use strict";
  const base="content/business_architecture/runtime/";
  const files=["part4-0.txt", "part4-1.txt", "part4-2.txt", "part4-3.txt", "part4-4.txt"];
  ...
  async function install(){
    ...
    return window.BusinessArchitectureContentV136 && window.BusinessArchitectureContentV136["PART-04"];
  }
  window.BusinessArchitectureContentLoaderV136=window.BusinessArchitectureContentLoaderV136||{};
  window.BusinessArchitectureContentLoaderV136["PART-04"]=install();
})();
