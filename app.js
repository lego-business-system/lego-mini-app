...
/* =====================================================
   v103 — Дополнительные материалы: Расчёт точки безубыточности
   Полное внедрение в файл, без отдельного patch-файла.
   ===================================================== */
var BREAK_EVEN_VERSION_V103 = 'v103-break-even-full-files-20260704';
var BREAK_EVEN_LESSON_CODE_V103 = 'ADD-BEP-01';
var BREAK_EVEN_SHEET_URL_V103 = 'https://docs.google.com/spreadsheets/d/1z3rPU1YJhmfaGKZcXnKh4cEepwdmOP19/edit?gid=1853890209#gid=1853890209';
var BREAK_EVEN_IMG_BASE_V103 = 'assets/additional/break_even/slides/';
var BREAK_EVEN_EVENTS_KEY_V103 = 'architecture_extra_material_events_v103_';

function breakEvenUserSuffixV103() {
  try {
    ...
    if (names && names[0]) return String(names[0]);
  } catch(e) {}
  return 'local';
}
function breakEvenEventStorageKeyV103() { return BREAK_EVEN_EVENTS_KEY_V103 + breakEvenUserSuffixV103(); }
function breakEvenEventsV103() {
  try {
    var parsed = JSON.parse(localStorage.getItem(breakEvenEventStorageKeyV103()) || '{}');
    return parsed && typeof parsed === 'object' ? parsed : {};
  } catch(e) { return {}; }
}
function saveBreakEvenEventsV103(map) { try { localStorage.setItem(breakEvenEventStorageKeyV103(), JSON.stringify(map || {})); } catch(e) {} }
function awardBreakEvenEventV103(eventKey, eventType, payload) {
  var key = String(eventKey || '').trim();
  if (!key) return null;
  try {
    if (typeof awardResearchPointOnceV91 === 'function') return awardResearchPointOnceV91(key, eventType || 'research_event', payload || {});
  } catch(e) {}
  var map = breakEvenEventsV103();
  if (!map[key]) {
    map[key] = { eventKey:key, eventType:eventType || 'research_event', points:1, payload:payload || {}, createdAt:nowIso ? nowIso() : new Date().toISOString() };
    saveBreakEvenEventsV103(map);
  }
  return map[key];
}
function breakEvenCountEventsV103(prefix) {
  return Object.keys(breakEvenEventsV103()).filter(function(key){ return String(key).indexOf(prefix) === 0; }).length;
}
function breakEvenViewedSlidesV103() { return breakEvenCountEventsV103('slide:' + BREAK_EVEN_LESSON_CODE_V103 + ':'); }
function breakEvenWorkMaterialsV103() { return breakEvenCountEventsV103('work_material:' + BREAK_EVEN_LESSON_CODE_V103 + ':'); }
function breakEvenExtraPointsV103() { return Object.keys(breakEvenEventsV103()).length; }
function breakEvenPadV103(n) { return String(Number(n || 0)).padStart(3, '0'); }
function openExternalBreakEvenUrlV103(url) {
...
var BREAK_EVEN_SLIDES_V103 = [
    {
      n:1,
      title:'Главный вопрос точки безубыточности',
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_001.png',
    ...
    },
    {
      ...
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_002.png',
    ...
    },
    {
      ...
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_003.png',
    ...
    },
    {
      ...
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_004.png',
    ...
    },
    {
      ...
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_005.png',
    ...
    },
    {
      ...
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_006.png',
    ...
    },
    {
      ...
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_007.png',
    ...
    },
    {
      ...
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_008.png',
    ...
    },
    {
      ...
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_009.png',
    ...
    },
    {
      ...
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_010.png',
    ...
    },
    {
      ...
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_011.png',
    ...
    },
    {
      ...
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_012.png',
    ...
    },
    {
      ...
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_013.png',
    ...
    },
    {
      ...
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_014.png',
    ...
    },
    {
      ...
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_015.png',
    ...
    },
    {
      ...
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_016.png',
    ...
    },
    {
      ...
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_017.png',
    ...
    },
    {
      ...
      image: BREAK_EVEN_IMG_BASE_V103 + 'add_bep_018.png',
...
function renderAdditionalMaterials() {
  awardBreakEvenEventV103('block:additional_materials', 'block_open', { block:'additional_materials' });
  var html = `
    ${card('blue-card-v2 additional-hero-v102', `<p class="eyebrow">дополнительные материалы</p><h1>Дополнительные материалы</h1><p>Практические уроки, инструменты и таблицы, которые можно проходить отдельно от основного маршрута.</p>`)}
    ${card('', `<h2>Финансы и учёт</h2><div class="additional-list-v102"><button class="additional-material-card-v102" onclick="renderBreakEvenHubV103()"><span>ТБ</span><div><b>Расчёт точки безубыточности в моём бизнесе</b><p>18 слайдов теории, затем рабочая таблица для самостоятельного расчёта.</p><em>доступно · 18 страниц · 1 рабочий материал</em></div></button></div>`)}
    ${card('', `<h2>Скоро</h2><div class="list-clean"><div><b>Финансовые коэффициенты</b><p>Ликвидность, устойчивость, маржинальность и диагностика бизнеса.</p></div><div><b>Платёжный календарь</b><p>Практический инструмент для контроля кассовых разрывов.</p></div></div><button class="btn secondary" onclick="renderHome()">На главную</button>`)}
  `;
  shell(html, 'home');
}
function renderBreakEvenHubV103() {
  awardBreakEvenEventV103('lesson:' + BREAK_EVEN_LESSON_CODE_V103, 'lesson_open', { lessonCode:BREAK_EVEN_LESSON_CODE_V103, module:'additional_materials', title:'Расчёт точки безубыточности в моём бизнесе' });
  var html = `
    ${card('blue-card-v2 bep-hub-v102', `<p class="eyebrow">практический урок</p><h1>Расчёт точки безубыточности в моём бизнесе</h1><p>Урок объясняет, как определить минимальную выручку, количество продаж и денежный порог, при котором бизнес перестаёт работать в минус.</p>`)}
    ${card('', `<h2>Как устроен материал</h2><div class="list-clean"><div><b>1. Теория</b><p>18 страниц: маржинальный доход, маржинальность, постоянные и переменные расходы, ТБ в выручке, ТБ в единицах, денежная ТБ и запас прочности.</p></div><div><b>2. Практическая таблица</b><p>После урока открывается Google Таблица. Её нужно скопировать себе и заполнить по инструкции.</p></div><div><b>3. Управленческий вывод</b><p>Финальный результат — не просто цифра ТБ, а решение: что менять в цене, марже, расходах, чеке, миксе или денежной нагрузке.</p></div></div><div class="grid-v2"><button class="btn primary" onclick="startBreakEvenSlidesV103()">Начать урок</button><button class="btn secondary" onclick="renderBreakEvenTableV103()">Открыть практическую таблицу</button><button class="btn secondary" onclick="renderAdditionalMaterials()">К дополнительным материалам</button></div>`)}
  `;
  shell(html, 'home');
}
function startBreakEvenSlidesV103() {
  localStorage.setItem('architecture_bep_slide_index_v103', '0');
  renderBreakEvenSlideV103(0);
}
function renderBreakEvenSlideV103(index) {
  var max = BREAK_EVEN_SLIDES_V103.length;
  var i = Math.max(0, Math.min(Number(index || 0), max - 1));
  var slide = BREAK_EVEN_SLIDES_V103[i];
  localStorage.setItem('architecture_bep_slide_index_v103', String(i));
  awardBreakEvenEventV103('lesson:' + BREAK_EVEN_LESSON_CODE_V103, 'lesson_open', { lessonCode:BREAK_EVEN_LESSON_CODE_V103, module:'additional_materials' });
  awardBreakEvenEventV103('slide:' + BREAK_EVEN_LESSON_CODE_V103 + ':' + breakEvenPadV103(slide.n), 'slide_open', { lessonCode:BREAK_EVEN_LESSON_CODE_V103, slideNo:slide.n, module:'additional_materials' });
  var prevDisabled = i === 0 ? 'disabled' : '';
  var nextText = i === max - 1 ? 'К таблице' : 'Далее';
  var nextAction = i === max - 1 ? 'renderBreakEvenTableV103()' : 'renderBreakEvenSlideV103(' + (i + 1) + ')';
  var img = `<img src="${slide.image}?v=${BREAK_EVEN_VERSION_V103}" alt="${esc(slide.title)}" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';"><div class="image-missing-v2" style="display:none"><b>Слайд ${slide.n}</b><p>Иллюстрация будет добавлена после генерации изображения.</p></div>`;
  var html = `
    <div class="nav-panel-v2 nav-panel-v2-three"><button class="btn secondary" onclick="renderBreakEvenHubV103()">К уроку</button><button class="btn secondary" ${prevDisabled} onclick="renderBreakEvenSlideV103(${i - 1})">Назад</button><button class="btn primary" onclick="${nextAction}">${nextText}</button></div>
    <div class="media-counter">Расчёт точки безубыточности · страница ${slide.n}/${max}</div>
    <div class="media-box-v2 bep-media-v102">${img}</div>
    <section class="slide-text-v2 bep-slide-text-v102">${slide.html}</section>
  `;
  shell(html, 'home');
}
function renderBreakEvenTableV103() {
  awardBreakEvenEventV103('lesson:' + BREAK_EVEN_LESSON_CODE_V103, 'lesson_open', { lessonCode:BREAK_EVEN_LESSON_CODE_V103, module:'additional_materials' });
  awardBreakEvenEventV103('work_material:' + BREAK_EVEN_LESSON_CODE_V103 + ':break_even_table', 'work_material_open', {
    lessonCode:BREAK_EVEN_LESSON_CODE_V103,
...
(function installArchitectureHierarchyV40(){
  ...
  function secondaryBlocksHtmlV40(){
    ...
    return `<div class="secondary-track-grid-v22 architecture-secondary-tracks-v40">
      ...
      ${renderMainBlockCard('Дополнительные материалы','Практические уроки, таблицы и инструменты вне основного маршрута.','доступно','renderAdditionalMaterials()','active compact-card')}
...
(function installArchitectureLibrarySystemsV43(){
  ...
  window.totalPoints = function(){
    ...
    var additionalValue = typeof breakEvenExtraPointsV103 === 'function' ? breakEvenExtraPointsV103() : 0;
    return lessonPoints + Number(challengeValue || 0) + Number(additionalValue || 0);
  };
  ...
  */
  ...
  function readingStatsV44(){
    ...
    return {
      ...
      pages:lessonPagesTotalV44() + challengeTrackedPagesV44() + (typeof breakEvenViewedSlidesV103 === 'function' ? breakEvenViewedSlidesV103() : 0),
      tests:lessonTests + passedChallengeBooks,
      bookSummaries:lessonBooks + passedChallengeBooks,
      templates:templates + (typeof breakEvenWorkMaterialsV103 === 'function' ? breakEvenWorkMaterialsV103() : 0),
      insights:insights
    };
  }
