...
const APP_CACHE_VERSION = "v83-finance-images-callouts-bottomnav-trainer-clean-20260629";
...
(function installFinanceCleanV77(){
  window.APP_UI_VERSION_V77 = 'v83-finance-images-callouts-bottomnav-trainer-clean-20260629';
  ...
  function financeSlideImageHtmlV83(sectionId, lessonId, slideNo, title){
    ...
    return `<div class="finance-slide-image-v83" data-path="${fEsc(path)}"><img src="${fEsc(path)}" alt="${fEsc(alt)}" loading="lazy" onerror="this.closest('.finance-slide-image-v83').classList.add('is-missing'); this.remove();"><div class="finance-slide-image-fallback-v83"><b>Изображение не найдено</b><p>${fEsc(path)}</p></div></div>`;
  }
...
(function installFinanceV81NavigationFix(){
  window.APP_UI_VERSION_V81 = 'v83-finance-images-callouts-bottomnav-trainer-clean-20260629';
  ...
  window.bottomNav = function(active){
    ...
    const financeButton = adminModeV81()
      ? `<button class="bottom-item ${active==='finance'?'active':''}" onclick="openFinanceAssistantV81()">${financeIcon}<b>Финансовый помощник</b></button>`
      : `<button class="bottom-item is-disabled-v41" type="button" disabled aria-disabled="true" title="Раздел закрыт для учеников">${financeIcon}<b>Финансовый помощник</b><small>закрыто</small></button>`;
...
(function installFinanceDrawerV82(){
  window.APP_UI_VERSION_V82 = 'v83-finance-images-callouts-bottomnav-trainer-clean-20260629';
